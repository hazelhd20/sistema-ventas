...
<div class="bg-white rounded-lg shadow p-4 mb-6">
    <form method="GET" action="<?php echo BASE_URL; ?>ventas" id="formFiltros" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    <i class="fas fa-user"></i> Cliente (ID)
                </label>
                <input type="text" name="idCliente" value="<?php echo htmlspecialchars($idCliente ?? ''); ?>" 
                       placeholder="ID Cliente" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    <i class="fas fa-user-tie"></i> Vendedor
                </label>
                <select name="idUsuario" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <select name="idFormaPago" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo BASE_URL; ?>ventas" class="bg-gray-400 hover:bg-gray-500 text-white px-6 py-2 rounded-lg transition-all">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors cursor-pointer" onclick="window.location.href='<?php echo BASE_URL; ?>ventas/detalle/<?php echo $venta['idVenta']; ?>'">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">
                                ...
                                if ($venta['cliente_nombre']) {
                                    ...
                                    echo '<span class="text-gray-400">Público General</span>';
                                }
                                ?>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <i class="fas fa-credit-card text-xs text-gray-400 mr-1"></i>
